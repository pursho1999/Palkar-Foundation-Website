...
insert($query1, [$CUST_ID, $_SESSION['room']['id'], $_SESSION['checkin1'], $_SESSION['checkout1'], 'Pending', ord_id($CUST_ID), trans_id(), $TXN_AMOUNT, 'Failure'], 'iisssssss');
...
<body>
 <div class="payment-container">
  <div class="payment-failed">
   ...
   <p>Your payment has failed. Please try again or contact support for assistance.</p>
