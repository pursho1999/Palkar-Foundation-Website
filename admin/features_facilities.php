                ...
                <div class="card border-0 shadow mb-4">
                  <div class="card-body">
                     ...
                     <div class="table-responsive-md" style="height: 350px; overflow-y:scroll">
                        <table  able class="table table-hover border">
                           <thead >
            ...
            <form id="feature_s_form">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="reset"
                            class="btn text-secondary shadow-none" data-bs-dismiss="modal">Reset</button>
            ...
            <form id="facility_s_form">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-bold">Icon(only svg/png)</label>
                            <input type="file" name="facility_icon" 
                                accept=".svg, .png" class="form-control shadow-none" required>
                        </div>
