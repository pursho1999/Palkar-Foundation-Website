...
<div class="card border-0 shadow mb-4">
    <div class="card-body">
        ...
        <a href="?del=all" class="btn btn-danger rounded-pill shadow-none"><i class="bi bi-trash"></i>  Delete all</a>
    ...
    while ($row = mysqli_fetch_assoc($data)) 
    {
        ...
        $seen.="<a href='?del=$row[sr_no]' class='btn btn-sm rounded-pill btn-danger mt-2 mb-2 ms-2'>Delete</a>";
        echo<<<query
            <tr>
                <td>$i</td>
                <td>{$row['name']}</td>
