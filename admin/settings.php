                    ...
                    <div class="container-fluid p-0">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    <label for="pn1_inp" class="form-label fw-bold">Phone Numbers (with country code)</label>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="fb_inp" class="form-label fw-bold">Facebook</label>
                                    <div class="input-group mb-3">
                                ...
                                <div class="mb-3">
                                    <label for="tw_inp" class="form-label fw-bold">Twitter</label>
                                    <div class="input-group mb-3">
                                ...
                                <div class="mb-3">
                                    <label for="insta_inp" class="form-label fw-bold">Instagram</label>
                                    <div class="input-group mb-3">
