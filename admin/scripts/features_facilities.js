    ...
    function rem_feature(val) 
    {
        ...
        xhr.onload = function () {
            ...
            {
                alert('error', 'Error: Unable to remove Feature (present in another room already!)');
            }
        }
...
// Assuming facility_s_form is defined somewhere in your code
...
function add_facility() {
    ...
    xhr.onload = function () {
        if (this.responseText == 1) {
            ...
            get_facilities(); // Corrected function name
        } else if (this.responseText == 'room_added') {
            alert('error', 'Facility is added in the room');
        } else {
            alert('error', 'Failed to remove Facility!');
        }
    };
