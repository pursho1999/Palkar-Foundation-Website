    ...
    {
        let contacts_p_id = ['address', 'gmap', 'pn1', 'pn2', 'email', 'fb', 'tw', 'insta'];
    ...
    {
        let contacts_inp_id = ['address_inp', 'gmap_inp', 'pn1_inp', 'pn2_inp', 'email_inp', 'fb_inp', 'tw_inp', 'insta_inp', 'iframe_inp'];
    ...
    function add_member() {
        ...
        data.append('picture', member_picture_inp.files[0]); //kitti bhi image seleect karo 1st file hi upload hogi
